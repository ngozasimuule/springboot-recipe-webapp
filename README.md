...
2. MOCK DATA for MySql Queries to add to MySql Workbench to help operate CRUD Operations:
    ...
    a) INSERT THE 'INSERT INTO' QUERY PLUS THE 'ALTER TABLE' QUERY IN ONE FILE/ ON SAME TAB IN MYSQL WORKBENCH TO EXECUTE QUERY AND HELP SEE DATA IN BROWSER. PLEASE SEE        QUERIES BELOW TO COPY AND PASTE: 
